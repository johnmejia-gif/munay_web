import {
  PRACTICE_ACTIVITIES, PRACTICE_ACTIVITY_SELECTED, PRACTICE_LOADING,
  PRACTICE_ACTIVITIES_LIKED, PRACTICE_PERCENTAGE, PRACTICE_SELECTED_READINGS,
  PRACTICE_LIST_READINGS, PRACTICE_LIST_READINGS_LOADING, PRACTICE_LIST_PLAYLIST,
  PRACTICE_LIST_PLAYLIST_LOADING, PRACTICE_SELECTED_PLAYLIST, PRACTICE_DIGITAL_FAST_TUTORIAL,
  PRACTICE_DIGITAL_FAST_HOURS, PRACTICE_DIGITAL_FAST_MINUTES, PRACTICE_DIGITAL_SUBSECTION,
  PRACTICE_DIGITAL_FASTING_STATUS, PRACTICE_DIGITAL_FASTINGS, PRACTICE_DIGITAL_FASTINGS_LOADING,
  PRACTICE_DIGITAL_FASTINGS_FRIENDS, PRACTICE_DIGITAL_FASTINGS_MODAL, PRACTICE_DIGITAL_FASTINGS_USER,
  PRACTICE_DIGITAL_FASTINGS_CONGRATULATIONS, PRACTICE_DIGITAL_GRAPHICS, PRACTICE_INTERMITTENT_TUTORIAL,
  PRACTICE_INTERMITTENT_STATUS, PRACTICE_INTERMITTENT_GRAPH, PRACTICE_INTERMITTENT_HISTORIAL,
  PRACTICE_LIST_READINGS_VIEWS, PRACTICE_LIST_READINGS_PAGE
